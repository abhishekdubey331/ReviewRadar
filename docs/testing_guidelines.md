...
*   **Safety Alerts Fast-Path (Commit 14):** Assert that calling `reviews.get_critical_alerts` returns *only* reviews matching the safety criteria, ignoring all others.

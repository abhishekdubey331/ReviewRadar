...
### 6.6 Safety Extraction (`reviews.get_critical_alerts`) *Optional/Practical*
...
4.  **Safety Workflow**: Deployment of `reviews.get_critical_alerts` and associated deterministic guardrails.

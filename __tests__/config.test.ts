...
describe('Configuration Validation', () => {
    ...
    it('should fail if no OpenAI key is provided', () => {
        const result = configSchema.safeParse({});
...
describe('Configuration diagnostics', () => {
    ...
    it('does not expose API key previews in diagnostics', () => {
        ...
        expect(diagnostics).not.toHaveProperty('has_anthropic_key');
        expect(diagnostics).not.toHaveProperty('configured_provider');
